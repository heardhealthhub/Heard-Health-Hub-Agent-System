...
const UserThemeOptions = (): ThemeOptions => {
  ...
  return {
    ...
    // palette:{
    //   primary: {
    //     light: '#fdf9f0', // Lighter, good for backgrounds or active elements
    //     main: '#fcf2dc',  // Original primary color
    //     dark: '#c9bfa3',  // Darker, good for text or passive elements
    //     contrastText: '#251f32' // Using your secondary color for contrast
    //   },
    //   secondary: {
    //     light: '#4a4352', // Lighter, less saturation
    //     main: '#251f32',  // Original secondary color
    //     dark: '#1a1624',  // Darker, more saturation
    //     contrastText: '#fcf2dc' // Using your primary color for contrast
    //   },
    //   error: {
    //     light: '#5f8a91', // Lighter, less saturation
    //     main: '#225e6f',  // Original accent color
    //     dark: '#1a4957',  // Darker, more saturation
    //     contrastText: '#fcf2dc' // Using your primary color for contrast
    //   },
    // },
